...
export const PairCard = observer(({ pair }: PairCardProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Absolute change */}
      {priceData && (
        <div className={clsx("text-[12px] mt-1", isPositive ? "text-green-500" : "text-red-500")}>
          {isPositive ? "+" : ""}
      ...
      <div
        className={clsx(
          ...
          flash === "up" ? "bg-green-500 opacity-100" : flash === "down" ? "bg-red-500 opacity-100" : "opacity-20",
        )}
