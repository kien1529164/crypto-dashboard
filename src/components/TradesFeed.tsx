...
export const TradesFeed = observer(() => {
  ...
  return (
    <div className="bg-[#1a1d27] border border-[#2a2d3a] rounded-xl overflow-hidden flex flex-col h-[480px]">
      {/* Header */}
      ...
      {/* Column headers */}
      <div className="grid grid-cols-3 px-4 py-2 text-[11px] text-slate-500 border-b border-[#1e2130]">
